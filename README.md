...
jobs:
  build-test:
    ...
    steps:
      ...
      - name: Test Report
        uses: step-security/test-reporting@v8
...
The scripts and documentation in this project are released under the [MIT License](https://github.com/step-security/test-reporting/blob/main/LICENSE)
